...
class Assets {
	public static function enqueue_core() {
		...
		wp_enqueue_script( 'afcn-card-order', AFCN_URL . 'assets/js/card-drag.js', array( 'afcn-browser' ), file_exists( $card_drag_js ) ? (string) filemtime( $card_drag_js ) : AFCN_VERSION, true );
