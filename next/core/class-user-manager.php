...
class User_Manager {
	public static function can_access() {
		return current_user_can( 'manage_options' ) || current_user_can( Capabilities::ACCESS );
	}

	public static function can_manage_users() {
		return current_user_can( 'manage_options' ) || current_user_can( Capabilities::MANAGE_USERS );
	}
	...
	public static function current_user_summary() {
		...
		return array(
			...
			'can_modules'  => current_user_can( 'manage_options' ) || current_user_can( Capabilities::MANAGE_MODULES ),
			'can_settings' => current_user_can( 'manage_options' ) || current_user_can( Capabilities::MANAGE_SETTINGS ),
		);
	}
	...
	public static function create_user( $payload ) {
		...
		Debug_Logger::info( 'Airfiber user created.', array( 'user_id' => (int) $user_id, 'role' => $role ) );
		return $result;
	}
	...
	public static function delete_user( $user_id ) {
		...
		Debug_Logger::warning( 'Airfiber user deleted.', array( 'user_id' => $user_id ) );
