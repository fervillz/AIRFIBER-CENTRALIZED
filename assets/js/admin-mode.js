( function ( $ ) {
	...
	function loadDashboardBootstrapFix() {
		if ( document.getElementById( 'afc-dashboard-bootstrap-fix-js' ) ) {
			return;
		}
		const source = document.querySelector( 'script[src*="/assets/js/admin-mode.js"]' );
